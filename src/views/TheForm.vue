    ...
    <div class="page">
        <form action="">
          ...
          <div class="input">
            ...
            <input :class="[ temperatura_agua=== '' ? 'input-erro': '']" type="number" v-model="temperatura_agua">
          </div>
          <div class="input">
            <label for="">Residual Desinfetante</label>
            <input :class="[ residual_desinfetante=== '' ? 'input-erro': '']" type="number" v-model="residual_desinfetante">
          </div>
          <div class="input">
            <label for="">Total Residual</label>
            <input :class="[ total_residual=== '' ? 'input-erro': '']" type="number" v-model="total_residual">
          </div>
          <div class="input">
            <label for="">Transparência</label>
            <select name="transparencia" v-model="transparencia" :class="[ transparencia=== '' ? 'input-erro': '']">
          ...
          <div class="input">
            ...
            <select name="lavagem_filtros" v-model="lavagem_filtros" :class="[ lavagem_filtros=== '' ? 'input-erro': '']">
          ...
          <div class="input">
            ...
            <input :class="[ num_banhistas=== '' ? 'input-erro': '']" type="number" v-model="num_banhistas">
          </div>
          <div class="input">
            <label for="obs">Observações</label>
            <input :class="[ observacoes=== null ? 'input-erro': '']" type="text" v-model="observacoes">
          </div>
...
const validade = computed(() => {
  ...
  return numValido && phCimaValido && temperatura_agua_Valido && residual_desinfetante_Valido && total_residual_Valido && volume_Valido;
});
...
function preencher(){
  ...
  if(validade.value && horas.value!=null && month!=null && day!=null && transparencia.value!=null && lavagem_filtros.value!=null){
    const form={
      horas:horas,
      ph:ph,
